...
const axiosInstance = axios.create({
  baseURL: process.env.NEXT_PUBLIC_API_BASE_URL || "https://sandbox.iconadmissionaid.com/api/v1",
  headers: {
      ...
      if (!isRefreshing) {
        ...
        try {
          ...
          const response = await axios.get(
            `${process.env.NEXT_PUBLIC_API_BASE_URL || "https://sandbox.iconadmissionaid.com/api/v1"}/auth/refresh-token`,
            {
              headers: {
