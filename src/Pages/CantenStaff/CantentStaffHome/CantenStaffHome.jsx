...
const CantenStaffHome = () => {
    ...
    return (
        <div className="container mx-auto p-4">
          ...
          <h2 className="text-xl font-bold tracking-tight">Cafeteria Management</h2>
          <div className="flex items-center space-x-2">
            <button className="px-2 py-2 bg-blue-600 text-white rounded-md cursor-pointer text-sm">Add New Menu Item</button>
          </div>
        </div>
      ...
      <div className="flex flex-wrap justify-center sm:justify-start space-x-2 sm:space-x-4  bg-gray-200  w-fit px-5 rounded-lg py-1">
        {["overview", "breakfast", "lunch", "dinner", "special"].map((tab) => (
          <button
            key={tab}
