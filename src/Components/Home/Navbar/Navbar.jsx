...
export default function Navbar() {
    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full z-50 px-4 md:py-3 mt-5 transition-all duration-300 ${mobileMenuOpen
        ...
        >
            <div className="container mx-auto flex items-center justify-between gap-4 ">
                ...
                <div className="flex-shrink-0">
                    <img src={logo} alt="logo" className="w-20 h-10 md:w-full md:h-full" />        </div>
                ...
                <div className="hidden lg:flex items-center gap-6">
                    {["Home", "Courses", "Books", "Free Class", "Free Test"].map((link) => (
                        <a
                            key={link}
                            href="#"
