...
export default function Layout({
  ...
  const sidebarMenuData: SidebarMenuItem[] = [
...

    {
      ...
      children: [
        ...
        },
        {
          ...
          href: "/admin/course/create-module",
          icon: <MdAdd size={18} />,
        },
      ],
    },
...

    {
     ...
     {
      label: "Model Test Manage",
      icon: <MdMenuBook size={20} />,
      children: [
        {
          label: "All Model Test List",
          href: "/admin/model-test/all-model-test",
          icon: <MdList size={18} />,
        },
        {
          label: "Create new Model Test",
          href: "/admin/model-test/create-model-test",
          icon: <MdAdd size={18} />,
        },
      ],
    },
    ...
    {
      label: "Delivery Charge Manage",
      icon: <MdRedeem size={20} />,
      children: [
        {
          label: "All Delivery Charges",
          href: "/admin/delivery-charge/all-delivery-charge",
          icon: <MdList size={18} />,
        },
      ],
    },
    {
      label: "Data Manage",
      icon: <MdRedeem size={20} />,
      href: "/admin/test/all-test",
      children: [],
    },
    {
      label: "Result Manage",
      icon: <MdRedeem size={20} />,
      href: "/admin/result/all-result",
      children: [],
    },
    {
      label: "Banner Manage",
  ...
  return (
    <section className="bg-body-light dark:bg-dark-body group-data-[theme-width=box]:container group-data-[theme-width=box]:max-w-screen-3xl xl:group-data-[theme-width=box]:px-4">
      {/* <!-- Start Header --> */}
